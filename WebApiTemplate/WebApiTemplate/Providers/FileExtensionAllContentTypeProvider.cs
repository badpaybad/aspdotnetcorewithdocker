...
namespace WebApiTemplate.Providers
{
    ...
    /// </summary>
    public class FileExtensionAllContentTypeProvider : IContentTypeProvider
    {
        #region Extension mapping table
        /// <summary>
        /// Creates a new provider with a set of default mappings.
        /// </summary>
        public FileExtensionAllContentTypeProvider()
        ...
        public FileExtensionAllContentTypeProvider(IDictionary<string, string> mapping)
        {
            if (mapping == null)
            {
